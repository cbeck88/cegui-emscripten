...
function(_BuildDynamicTarget name type)
    ...
    foreach(dir ${ARGN})
		...
		MESSAGE( STATUS "Excluding " ${dir} )
                if (dir MATCHES "\\/\\*\\*$")
		    MESSAGE( STATUS "It matches pattern" )
		    ...
		    MESSAGE( STATUS "It does not match pattern" )
                    file(GLOB _files RELATIVE ${CMAKE_CURRENT_SOURCE_DIR}
                        ${dir}
                    )
                endif()
		list(LENGTH _files files_LENGTH)
		MESSAGE( STATUS "That was " ${files_LENGTH} " files matching." )
		list(LENGTH _source_files source_files_LENGTH)
		MESSAGE( STATUS "There were " ${source_files_LENGTH} " source files." )
                if(_files)
                    list(REMOVE_ITEM _source_files
                        ${_files}
                    )
		    list(LENGTH _source_files source_files_LENGTH)
		    MESSAGE( STATUS "There are " ${source_files_LENGTH} " source files left." )
                endif()
                set(_files)
	...
	if (EMSCRIPTEN)
		# Override... according to tutorial shared is better than static for emscripten... 
