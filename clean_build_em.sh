...
export CXX_FLAGS="$COMMON_FLAGS -std=c++11 -Wall -Werror -Wno-unused -Wno-format -Wno-switch -Wno-\#pragma-messages -s USE_SDL=2 -s DEMANGLE_SUPPORT=1 --llvm-lto 1 -s TOTAL_MEMORY=500000000 -s NO_EXIT_RUNTIME=1" #$DEBUG_FLAGS"
